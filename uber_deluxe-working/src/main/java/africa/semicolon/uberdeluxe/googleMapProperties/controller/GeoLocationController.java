...
import africa.semicolon.uberdeluxe.googleMapProperties.Service.GeoLocationService;
...
public class GeoLocationController {
    ...
    public ResponseEntity<LocationB> getCurrentLocation(HttpServletRequest request) throws IOException {
        return new ResponseEntity<>(geoLocationService.getLocation(request), HttpStatus.OK);
    }
